shinyUI(fluidPage( theme = "display.css",
                   withMathJax(),
                   ...
                   sidebarLayout(
                     ...
                     mainPanel(
                       tabsetPanel(
                         ...
                         tabPanel("$$\\text{Counterfactual 3d plot}$$",
                                  textInputRow("mina", label = h6("$$ \\text{min } a = $$  "),value = 0),
                                  textInputRow("maxa", label = h6("$$ \\text{ max } a = $$  "),value = 1),
                                  textInputRow("minb", label = h6("$$ \\text{ min } b = $$  "),value = 0),
                                  textInputRow("maxb", label = h6("$$ \\text{ max } b = $$  "),value = 1),
                                  plotOutput("D3plot")
                                  )
                       ))
                   )

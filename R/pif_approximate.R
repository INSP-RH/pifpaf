...
pif.approximate <- function(X, Xvar, thetahat, rr,
  ...
  warning(
    paste0(
      "Current method has been deprecated please use the `deltapif` ",
      "package instead. It can be found at https://github.com/RodrigoZepeda/deltapif ",
      "and includes additional functionality for approximate pafs and ",
      "an improved estimation of the intervals resulting in smaller and/or positive intervals."
    )
  )
